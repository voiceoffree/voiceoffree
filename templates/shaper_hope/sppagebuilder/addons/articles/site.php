    ...
    public function render() {
        ...
        if (count($items)) {
            ...
            foreach ($items as $key => $item) {
                ...
                $output .= '<div class="sppb-article-content-wrap">';
                ...
                if ($show_readmore) {
                    $output .= '<a class="sppb-readmore" href="' . $item->link . '" itemprop="url">' . $readmore_text . ' <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>';
                }
