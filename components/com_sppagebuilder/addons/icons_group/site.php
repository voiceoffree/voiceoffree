...
class SppagebuilderAddonIcons_group extends SppagebuilderAddons {
    ...
    public function css() {
        ...
        foreach ($this->addon->settings->sp_icons_group_item as $key => $addon_item) {
            ...
            $label_style .= (isset($addon_item->label_margin) && $addon_item->label_margin) ? 'margin: ' . $addon_item->label_margin . ';' : '';
            //Label Tablet style
            $label_style_sm = '';
            ...
            $label_style_sm .= (isset($addon_item->label_margin_sm) && $addon_item->label_margin_sm) ? 'margin:' . $addon_item->label_margin_sm . ';' : '';
            //Label Mobile style
            $label_style_xs = '';
            ...
            $label_style_xs .= (isset($addon_item->label_margin_xs) && $addon_item->label_margin_xs) ? 'margin:' . $addon_item->label_margin_xs . ';' : '';
            ...
            //Item Display
            $item_display = (isset($this->addon->settings->item_display) && $this->addon->settings->item_display) ? 'display: ' . $this->addon->settings->item_display . ';' : 'inline-block;';
