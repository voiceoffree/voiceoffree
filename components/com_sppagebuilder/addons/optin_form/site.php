...
class SppagebuilderAddonOptin_form extends SppagebuilderAddons{
	...
	public function render() {
		...
		$button_text 		= (isset($settings->button_text) && $settings->button_text) ? $settings->button_text : JText::_('COM_SPPAGEBUILDER_ADDON_OPTIN_FORM_SUBCSCRIBE');
	...
	public function css() {
		...
		if ($custom_input) {
			...
			$custom_input_style	.= (isset($settings->custom_input_padding) && $settings->custom_input_padding) ? 'padding: ' . $settings->custom_input_padding . ';' : '';
		...
		$custom_input_padding_sm = (isset($settings->custom_input_padding_sm) && $settings->custom_input_padding_sm) ? 'padding: ' . $settings->custom_input_padding_sm . ';' : '';
		...
		$custom_input_padding_xs = (isset($settings->custom_input_padding_xs) && $settings->custom_input_padding_xs) ? 'padding: ' . $settings->custom_input_padding_xs . ';' : '';
